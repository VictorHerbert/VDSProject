...
| OBDDManager(std::vector<Node> nodes)                           | [X]         | [X]    | Kamel  |
...
| Create scripts for automated verification | []          | Kamel  |
| Complemented Edges                        | []          | Kamel  |
| Standard Triples                          | []          | Victor |
...
| getInputs()              | []          | []     | Victor |
| isReachable()            | []          | []     | Kamel  |
| stateDistance()          | []          | []     | Victor |
| setTransitionFunctions() | []          | []     | Victor |
| setInitState()           | []          | []     | Victor |
